...
![GitHub repo size](https://img.shields.io/github/repo-size/gesbus/README-template?style=for-the-badge)
![GitHub language count](https://img.shields.io/github/languages/count/gesbus/README-template?style=for-the-badge)
![GitHub forks](https://img.shields.io/github/forks/gesbus/README-template?style=for-the-badge)

<img src="https://github.com/2006751/gesbus/blob/main/imagem-pb.jpg" alt="GESBUS">

GESBUS: Projeto Integrador Univesp 202204

## GESBus. Sistema de análise e monitoramento de empresas de ônibus. 
Trata-se de um sistema exemplo para demostração do projeto integrador da Univesp 2022/3
...
```
git clone git@github.com:<seu_usuário>/gesbus.git
```
...
```
spring.datasource.url=jdbc:mysql://<endereço-do-seu-banco>:<porta>/gesbus?useTimezone=true&serverTimezone=America/Sao_Paulo
